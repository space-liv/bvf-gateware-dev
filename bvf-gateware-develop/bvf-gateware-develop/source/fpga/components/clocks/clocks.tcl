# -------------------------------------------------------
# Create Smart Design and Disable Promotion
# -------------------------------------------------------
...
# -------------------------------------------------------
# Add Instances (FIC PLL locks, FPGA CCC, INIT MONITOR, 160 MHz, ADC CCC)
# -------------------------------------------------------
